...
<body class="bg-green-800 flex items-center justify-center h-screen">
    <div class="bg-green-200 p-8 rounded shadow-md w-96">
        <h2 class="text-3xl font-semibold mb-4 text-green-800">Login</h2>
        <form>
            <div class="mb-4">
            ...
            <button type="submit" class="bg-green-800 text-white py-2 px-4 rounded hover:bg-green-600">Login</button>
        </form>
    </div>
</body>
</html>
